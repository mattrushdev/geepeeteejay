...
MAX_LEN = 256  # this is the max length of the sentence

print("Loading GPT tokenizer...")
tokenizer = GPT2Tokenizer.from_pretrained("EleutherAI/gpt-neo-2.7B", do_lower_case=True)
...
def model_fn(model_dir):
    ...
    loaded_model = torch.jit.load(os.path.join(model_dir, "traced_gptj.pt"))
    print("================== model loaded =============================")
